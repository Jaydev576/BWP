...
describe('PROFILE: twitch', function () {
    var sl;
    beforeEach(function () {
    ...
    it('should twitch', function () {
        var profile = 'twitch';
        var profileId = 'gkucmierz';
        var desktop = "https://twitch.tv/".concat(profileId);
        var mobile = "https://m.twitch.tv/".concat(profileId);
        testProfile(profile, profileId, desktop, mobile);
    });
});
//# sourceMappingURL=twitch.spec.js.map