...
describe('PROFILE: vk', function () {
    ...
    it('should vk', function () {
        var profile = 'vk';
        var profileId = 'gkucmierz';
        var desktop = "https://vk.com/".concat(profileId);
        var mobile = "https://m.vk.com/".concat(profileId);
        testProfile(profile, profileId, desktop, mobile);
    });
});
//# sourceMappingURL=vk.spec.js.map