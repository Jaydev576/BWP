...
describe('PROFILE: soundcloud', function () {
    var sl;
    beforeEach(function () {
    ...
    it('should soundcloud', function () {
        var profile = 'soundcloud';
        var profileId = 'taylorswiftofficial';
        var desktop = "https://soundcloud.com/".concat(profileId);
        testProfileDesktop(profile, profileId, desktop);
    });
});
//# sourceMappingURL=soundcloud.spec.js.map