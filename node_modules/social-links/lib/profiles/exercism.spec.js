...
describe('PROFILE: exercism', function () {
    var sl;
    beforeEach(function () {
    ...
    it('should exercism', function () {
        var profile = 'exercism';
        var profileId = 'gkucmierz';
        var desktop = "https://exercism.io/profiles/".concat(profileId);
        testProfileDesktop(profile, profileId, desktop);
    });
});
//# sourceMappingURL=exercism.spec.js.map