...
describe('PROFILE: telegram', function () {
    var sl;
    beforeEach(function () {
    ...
    it('should telegram', function () {
        var profile = 'telegram';
        var profileId = 'gkucmierz';
        var desktop = "https://t.me/".concat(profileId);
        testProfileDesktop(profile, profileId, desktop);
    });
});
//# sourceMappingURL=telegram.spec.js.map